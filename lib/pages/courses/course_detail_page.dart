...
class CourseDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final prereq = course.prerequisiteCourseId != null
        ? cp.getCourseById(course.prerequisiteCourseId!)
        : null;
    ...
    return Scaffold(
          ...
          children: [
            ...
            if (activeEnrollments.isEmpty)
              const EmptyState(
                ...
                subtitle: 'Be the first to enroll a student',
              )
            else
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              '${student.program} • ${Formatters.formatShortDate(e.enrollmentDate)}',
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () =>
            showEnrollmentDialog(context, preselectedCourseId: courseId),
